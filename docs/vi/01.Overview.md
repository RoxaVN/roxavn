...
> Khi chạy `npx roxavn create module` đã tự động tạo cho bạn
...
Khuyến nghị sử dụng VSCode làm trình soạn thảo chính để đảm bảo đồng bộ môi trường làm việc giữa các thành viên trong dự án. Sau khi khởi tạo dự án, nên chạy lệnh `npx roxavn create module:convention` để tạo các cấu hình tiêu chuẩn:
...
Ngoài việc khởi tạo convention ban đầu, bạn có thể chạy lệnh `npx roxavn create editor:vscode` để tối ưu trải nghiệm phát triển trên **VSCode**. Lệnh này sẽ tự động:
